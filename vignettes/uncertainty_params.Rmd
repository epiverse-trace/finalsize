...
The infection **parameter ($R_0$) is uncertain**. You want to know how much variation this could cause in the estimated final size of the epidemic.
:::
...
This example considers a scenario in which susceptibility to infection does not vary.
