...
::: {.alert .alert-warning}
The __susceptibility matrix__ and the __demography-in-susceptibility matrix__ must always have the same dimensions.
...
::: {.alert .alert-warning}
**Recall** that each row of the demography-in-susceptibility matrix must always sum to 1.0!
:::
