...
The final size of an epidemic can be calculated using the _finalsize_ package, using methods detailed in [@miller2012](http://www.ncbi.nlm.nih.gov/pmc/articles/PMC3506030/). See the [Modelling Background vignette](modelling_background.html) for more on the theory underlying final size calculations.
