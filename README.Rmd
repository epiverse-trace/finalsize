...
# Calculate the final size of an epidemic <img src="man/figures/logo.png" align="right" width="120"/>
...
Here, an example using social contact data from the `socialmixr` package investigates the final size of an epidemic when the disease has an R<sub>0</sub> of 2.0, and given three age groups of interest --- 0-19, 20-39 and 40+.
