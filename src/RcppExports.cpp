...
// final_size_cpp
Eigen::VectorXd final_size_cpp(const double& r0, const Eigen::MatrixXd& contact_matrix, const Eigen::VectorXd& demography_vector, const Eigen::VectorXd& prop_initial_infected, Eigen::VectorXd prop_suscep, const int iterations);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type prop_suscep(prop_suscepSEXP);
...
// final_size_grps_cpp
Eigen::ArrayXd final_size_grps_cpp(const Eigen::MatrixXd& contact_matrix, const Eigen::VectorXd& demography_vector, const Eigen::MatrixXd& p_susceptibility, const Eigen::MatrixXd& susceptibility, const Rcpp::String& solver, const Rcpp::List& control);
RcppExport SEXP _finalsize_final_size_grps_cpp(SEXP contact_matrixSEXP, SEXP demography_vectorSEXP, SEXP p_susceptibilitySEXP, SEXP susceptibilitySEXP, SEXP solverSEXP, SEXP controlSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type contact_matrix(contact_matrixSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(final_size_grps_cpp(contact_matrix, demography_vector, p_susceptibility, susceptibility, solver, control));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_finalsize_final_size_grps_cpp", (DL_FUNC) &_finalsize_final_size_grps_cpp, 6},
