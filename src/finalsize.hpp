...
namespace finalsize {
  ...
  inline Eigen::ArrayXd solve_final_size_by_susceptibility(const Eigen::MatrixXd &contact_matrix,
    ...
    Eigen::ArrayXd pi_tmp = finalsize::solve_final_size_newton(s.m, s.demo_v, s.susc, 
  ...
  // [[Rcpp::export]]
  inline Eigen::VectorXd solve_final_size_internal(const Eigen::MatrixXd &contact_matrix,
                                          const Eigen::VectorXd &demography,
                                          const Eigen::MatrixXd &p_susceptibility,
                                          const Eigen::MatrixXd &susceptibility,
                                          const bool adapt_step = true,
    ...
    solve_final_size_by_susceptibility(contact_matrix, demography, p_susceptibility,
